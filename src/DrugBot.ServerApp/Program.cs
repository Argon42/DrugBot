...
builder.Services.AddMagicBallDb(builder.Configuration);
...
builder.Services.AddWisdomDb(builder.Configuration);
...
await app.Services.CreateScope().ServiceProvider.GetRequiredService<WisdomDbInitializer>().Initialize();
